...
/*
  ...
  'Ctrl-a'		 (0x01) - Serial test.  only accept the character after the 0x01
  'Ctrl-h'       (0x08) - debug toggle.  toggle the debug IO line up/down to trigger scope trace
